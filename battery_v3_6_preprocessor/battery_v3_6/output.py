...
def write_dataset(root: Path, selection: SelectionResult, jobs: int = 1) -> None:
    ...
    wrapper = (
        "from pathlib import Path\n"
        "from battery_v3_6.training_view import build_training_view\n"
        "from battery_v3_6.cli import training_view_main\n\n"
